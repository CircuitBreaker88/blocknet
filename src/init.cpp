...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-fastload", "Fast load increases program load speed by using more memory. Disable on memory constrained devices if out of memory errors persist (e.g. Rasp Pi)", false, OptionsCategory::OPTIONS);
